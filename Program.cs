...
GetColors(out string col1, out string col2, out string col3, out string colTol);
Decode4ColorBands(col1, col2, col3, colTol, out double resistorValue, out double Tolerance);
Console.WriteLine($"The resistor value is {resistorValue:n0} Ω and the Tolerance is +/- {Tolerance}%");

void GetColors(out string col1, out string col2, out string col3, out string colTol)
{
